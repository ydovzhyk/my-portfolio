...
const ChatWidget = () => {
  ...
  return (
    <>
      ...
      {isOpen && (
        <div className="fixed bottom-[120px] sm:bottom-8 left-1/2 -translate-x-1/2 sm:left-auto sm:translate-x-0 sm:right-24 z-50 w-[90%] sm:w-[320px] rounded-xl border border-neutral-700 p-4 shadow-xl text-white bg-gradient-to-r from-[#0d1224] to-[#0a0d37]">
